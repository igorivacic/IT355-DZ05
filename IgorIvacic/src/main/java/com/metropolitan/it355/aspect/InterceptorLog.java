...
public class InterceptorLog implements MethodBeforeAdvice {
    ...
    @After("execution(* com.it355.dao.impl.MobileDaoImpl.addMobile(..))")
    ...
    @AfterThrowing(
            pointcut = 
    "execution(*com.it355.dao.impl.StudentDaoImpl.addStudentThrowException ())",throwing= "error")
public void logAfterThrowing(JoinPoint joinPoint, Throwable error) {
    ...
    @Around("execution(* execution(*com.it355.dao.impl.StudentDaoImpladdStudentAround (..))")
